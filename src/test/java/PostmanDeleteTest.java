...
public class PostmanDeleteTest {
    @Test
    public static void postmanDeleteTest() {
        ...
        given()
                ...
                .when()
                .delete("/delete") // Отправляем запрос
                .then()
                ...
                .and().body("headers.content-type", is("text/plain; charset=utf-8"))//cgcvbcvbc
                ...
                .and().body("url", is("https://postman-echo.com/delete"));
    }
}
