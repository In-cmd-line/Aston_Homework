...
public class MtsLes14_2Test {
    ...
    private static final String MAIL_USER = "mummytroll@gmail.com";
    ...
    @Test
    @DisplayName("Проверка правильности входных данных на фрейме")
    ...
    @ParameterizedTest
    @DisplayName("Проверка плейсхолдеров на фрейме")
    ...
    @Test
    @DisplayName("Проверка лого на фрейме")
    void testMtsLes14_2() {
